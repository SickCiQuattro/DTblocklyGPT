/**
 * Paginated list of user accounts (manager-only), with search, delete and a link to the matching form.
 *
...
const ListUsers = () => {
  ...
  // tab's delete) made the empty-state ("No user accounts found") fire even
