...
const ListObjects = () => {
  ...
  // tab's delete) made the empty-state ("No objects found") fire even
  ...
  return (
    ...
    >
                  ...
                  <TableCell colSpan={6} align="center" sx={{ py: 6 }}>
                    <Stack spacing={1} sx={{ alignItems: 'center' }}>
                      <Typography variant="body2" color="error.dark">
                        Couldn&apos;t load objects. Check your connection and
                        try again.
                      </Typography>
      ...
      <ConfirmDialog
        open={deleteId !== null}
        loading={isDeleting}
        message="Delete this object? This can't be undone."
        confirmLabel="Delete"
        onConfirm={() => {
